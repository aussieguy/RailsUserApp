...
class ApikeysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create apikey" do
    assert_difference("Apikey.count") do
      post apikeys_url, params: { apikey: { apikey: @apikey.apikey, provider: @apikey.provider } }
    end
  ...
  test "should update apikey" do
    patch apikey_url(@apikey), params: { apikey: { apikey: @apikey.apikey, provider: @apikey.provider } }
